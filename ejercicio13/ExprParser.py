...
class ExprParser ( Parser ):
    ...
    literalNames = [ "<INVALID>", "'CREATE'", "'TABLE'", "'INSERT'", "'INTO'", 
                     "'VALUES'", "'SELECT'", "'FROM'", "'WHERE'", "'SERIAL'", 
                     "'VARCHAR'", "'INTEGER'", "'DATE'", "'NOT'", "'NULL'", 
                     "'PRIMARY'", "'KEY'", "'INNER'", "'JOIN'", "'ON'", 
                     "'='", "'('", "')'", "';'", "','", "'.'" ]

    symbolicNames = [ "<INVALID>", "CREATE", "TABLE", "INSERT", "INTO", 
                      "VALUES", "SELECT", "FROM", "WHERE", "SERIAL", "VARCHAR", 
                      "INTEGER", "DATE", "NOT", "NULL", "PRIMARY", "KEY", 
                      "INNER", "JOIN", "ON", "IGUAL", "PAR_A", "PAR_C", 
                      "SEMIC", "COMA", "PUNTO", "STRING", "NUM", "ID", "WS" ]
